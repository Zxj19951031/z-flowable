...
public class AuthenticationController {
    ...
    public SystemResponse<Integer> signUp(@RequestBody SignUpParameter parameter) {

        int userId = authenticationService.signUp(parameter.getUsername(), parameter.getPassword());
        return SystemResponse.success(userId);
    }
    ...
    public SystemResponse<List<ResourceNode>> getResource() {
        ...
        return SystemResponse.success(nodes);
    }
}
